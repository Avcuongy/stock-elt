...
CREATE TABLE IF NOT EXISTS industries (
    ...
    industry_update_time_stamp TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS sicindustries (
    ...
    sicindustry_update_time_stamp TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS exchanges (
    ...
    exchange_update_time_stamp TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    CONSTRAINT fk_exchange_region_id FOREIGN KEY (exchange_region_id) REFERENCES regions (region_id)
);
...
CREATE TABLE IF NOT EXISTS companies (
    ...
    company_update_time_stamp TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    CONSTRAINT fk_company_exchange FOREIGN KEY (company_exchange_id) REFERENCES exchanges (exchange_id),
    CONSTRAINT fk_company_industry_id FOREIGN KEY (company_industry_id) REFERENCES industries (industry_id),
    CONSTRAINT fk_company_sic_id FOREIGN KEY (company_sic_id) REFERENCES sicindustries (sic_id),
